...
function ProjectDetail({
  ...
  const canSyncProject =
    isProjectSyncEnvironmentEligible(syncEnvironmentCandidates, representative.environmentId) &&
    selectProjectSyncEnvironmentOptions(syncEnvironmentCandidates).length > 1;
          ...
          <SettingsRow
            ...
            description={
              canSyncProject
                ...
                : "Project sync needs this checkout's environment and another connected environment that supports project sync."
            }
            control={
              <Button
                size="xs"
